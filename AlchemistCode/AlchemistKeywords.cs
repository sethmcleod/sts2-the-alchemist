...
/// (loc keys <c>ALCHEMIST-METTLE</c> / <c>ALCHEMIST-FERMENT</c> in card_keywords.json).
///
/// These are display/tooltip keywords; the actual gameplay lives on <see cref="Cards.AlchemistCard"/>
/// (Mettle = <c>IsReduced</c> HP check; Ferment = the fermented-turn counter).
/// </summary>
public static class AlchemistKeywords
{
    ...
    public static CardKeyword Mettle;
