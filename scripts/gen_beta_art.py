...
COLORS = {
    ...
    "Percolate": ("#1f1723", "#7f9aa8", "BR", "Exhaust pile: skills"),
    ...
    "Dispense": ("#2f0170", "#b3341f", "TR", "Heavy attacks"),
    ...
    "Fester": ("#3a2a08", "#d9c26a", "TR", "Unique"),
    "Swamp Gas": ("#12331a", "#7fd4a0", "TR", "Unique"),
    "Heavy Hand": ("#2b1436", "#c98adf", "TR", "Unique"),
    "Toxin Skin": ("#1a2f14", "#a8d86b", "TR", "Unique"),
    "Taint": ("#4e8701", "#7a2f6b", "BR", "Poison skills"),
    "Weak Spot": ("#071a02", "#2ec4c9", "L", "Poison powers: amplifiers"),
    "Grudge": ("#071a02", "#5fbf8a", "R", "Poison powers: retaliation"),
    "Share The Pain": ("#071a02", "#4a7fd1", "L", "Poison powers: retaliation"),
    "Mercurial Form": ("#22203d", "#cfd6e3", "R", "Unique"),
    "Sublimate": ("#1a0d33", "#b98cff", "R", "Unique"),
    "Quench": ("#0a2f3a", "#7fe3c4", "BR", "Unique"),
    "Pays Off": ("#2f0170", "#f2b32e", "L", "Antitoxin"),
