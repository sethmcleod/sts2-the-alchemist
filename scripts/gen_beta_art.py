...
COLORS = {
    ...
    "Mellow": ("#2f0170", "#c46fd8", "R", "Ferment"),
    "Meltdown": ("#1a3a5c", "#7ee0c2", "TR", "Unique"),
    "Mercurial Form": ("#101b2e", "#8ef0c2", "TL", "Unique"),
    "Miasma": ("#071a02", "#6b8f2a", "L", "Poison powers: retaliation"),
    "Mortar": ("#2f0170", "#63c11c", "BR", "Unique"),
    ...
    "Pour Over": ("#3a1220", "#f0435e", "BR", "Ferment"),
    ...
    "Vial in Reserve": ("#1a2f14", "#a8d86b", "R", "Potions"),
