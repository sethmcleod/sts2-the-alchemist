...
public class TheAlchemistCardPool : CustomCardPoolModel
{
    public override string Title => TheAlchemist.CharacterId; //This is not a display name.
    ...
    {
        //This will attempt to load TheAlchemist/images/cards/frame.png
